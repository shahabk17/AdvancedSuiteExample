...
{
    [TestFixture, Category("ADO14727_TrackingOfFAQsPageElements")]
    [Parallelizable(ParallelScope.Children)]
    public class ADO14727_TrackingOfFAQsPageElements : BaseTestFixture
    {
        private const string className = "ADO14727_TrackingOfFAQsPageElements";
        public ADO14727_TrackingOfFAQsPageElements() : base(className, Properties.folderName, isHeadless: Properties.isHeadless) { }
        ...
        public static IEnumerable<TestCaseData> GetInputData()
        {
                ...
                .ReadInputData<InputData>(Properties.environment, className))
            {
                yield return new TestCaseData(input)
                    .SetName($"VerifyFAQsPageTracking{input.testSequence}");
            }
        }

        [Test, TestCaseSource(nameof(GetInputData))]
        [Author("Shahab Khan")]
        public void VerifyFAQsPageTracking(InputData user)
        {

            /**************************************************************
             * 
             * Test:- Check For different fields on FAQs page in the SCS
             * 
             * ************************************************************/
            ...
            Report.ChildLog = Report.ExtentTestGroup("Check and Verify FAQ Page Fields");
            fAQPageSteps.VerifyFieldsForTracking(IdNumber);
            Report.PrintAndClearStep(Report.ChildLog);
        }
    }
}